                ...
                <div>
                    ...
                    <div id="ShowProfileDiv">
                        ...
                        <div id="ShowProfilePic">
                            <img id="ShowProfileProfile" alt="profilePic" src={this.state.user.profile_photo === null ? "https://www.sketchengine.eu/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png" : "http://localhost:8080/image/" + this.state.user.profile_photo}
